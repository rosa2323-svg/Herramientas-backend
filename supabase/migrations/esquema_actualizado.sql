...
\restrict Ggca8XE39hRWL7QANFvKf4h1FdqoYOydJfjJb1gAZfjb0bhQECbcLHW6Q25aG2E
...
--
-- Name: producto_etiqueta; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.productos (
    ...
    imagen_url character varying(1000),
...
CREATE TABLE public.usuarios (
    ...
    numero_telefono character varying(9),
    CONSTRAINT chk_nombre_solo_letras CHECK (((nombre)::text ~ '^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$'::text))
);
...
--
-- Name: perfiles uktlt2ghp1wj8o1qco6mt6e9j14; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.perfiles
    ADD CONSTRAINT uktlt2ghp1wj8o1qco6mt6e9j14 UNIQUE (usuario_id);


--
-- Name: usuarios unique_dni; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ventas ventas_numero_orden_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ventas
    ADD CONSTRAINT ventas_numero_orden_key UNIQUE (numero_orden);
...
--
-- Name: productos fk_categoria; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.productos
    ADD CONSTRAINT fk_categoria FOREIGN KEY (categoria_id) REFERENCES public.categorias(id) ON DELETE RESTRICT;


--
-- Name: detalle_ventas fk_producto; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: detalle_ventas fk_venta; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: perfiles fkowo6q4m6x5tklwmure6pp4dae; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.perfiles
    ADD CONSTRAINT fkowo6q4m6x5tklwmure6pp4dae FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id);
...
--
-- Name: producto_etiqueta; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.producto_etiqueta ENABLE ROW LEVEL SECURITY;
...
\unrestrict Ggca8XE39hRWL7QANFvKf4h1FdqoYOydJfjJb1gAZfjb0bhQECbcLHW6Q25aG2E
